...
import { appendixData, PageContent } from '@/data/bookData'
...
export default function AppendixPage() {
    ...
    const [currentPage, setCurrentPage] = useState<PageContent | undefined>(appendixData[pageNum - 1])

    useEffect(() => {
        const page = appendixData[pageNum - 1]
        if (page) {
            setCurrentPage(page)
        } else {
  ...
  "mode": "Learn by Example"
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', gap: '10px' }}>
                            {appendixData.map((p: PageContent) => (
                                <motion.div
                                    key={p.id}
                                    style={{
