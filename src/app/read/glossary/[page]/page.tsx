...
export default function GlossaryPage() {
    ...
    useEffect(() => {
        ...
        // Save progress (Intro: 2 + S1-6: 56 + Lib: 6 + App: 6 = 70 pages total before Glossary)
        if (isAuthed) {
            authSystem.updateReadingProgress(70 + pageNum)
        }
    }, [pageNum, isAuthed])
    ...
    const handleNext = () => {
        ...
        if (!isLastPage) {
            ...
            // Explicitly mark Glossary as completed (Page 74 threshold)
            if (isAuthed) {
                authSystem.updateReadingProgress(74)
            }
            router.push('/toc')
        }
    }
