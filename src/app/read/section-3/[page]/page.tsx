...
export default function Section3Page() {
    ...
    const [currentPage, setCurrentPage] = useState(section3[pageNum - 1])

    useEffect(() => {
        const page = section3[pageNum - 1]
        if (page) {
            setCurrentPage(page)
        } else {
            router.push('/toc')
                    ...
                    <div className="read-layout-grid">
                        ...
                        <div style={{
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                {/* Prompt Box Overlay (Floating like reference) */}
                                <motion.div
                                    style={{
                                        position: 'absolute',
                                        bottom: '-20px',
  ...
  "ai_mode": "Expert"
                            ...
                            <div style={{
                                ...
                                <h4 style={{ color: '#FFB800', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    <span>💡</span> نصيحة الفصل
                                </h4>
                                <p style={{ color: '#b0b0b0', fontSize: '0.95rem', lineHeight: '1.6', margin: 0 }}>
                                    تذكر أن البرومبت الناجح يبدأ دائماً بتحديد الدور والسياق. في هذا القسم، نركز على الهيكل الذي يسبق التصميم والكود لضمان رحلة مستخدم سلسة.
                                </p>
                            </div>
                        </div>
                    </div>
