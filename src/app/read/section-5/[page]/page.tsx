...
import { section5, PageContent } from '@/data/bookData'
...
export default function Section5Page() {
    ...
    const [currentPage, setCurrentPage] = useState<PageContent | undefined>(section5[pageNum - 1])

    useEffect(() => {
        const page = section5[pageNum - 1]
        if (page) {
            setCurrentPage(page)
        } else {
  ...
  "ai_mode": "Critic"
                            ...
                            <div style={{
                                ...
                                <p style={{ color: '#b0b0b0', fontSize: '0.95rem', lineHeight: '1.6', margin: 0 }}>
                                    الجودة ليست رفاهية، بل هي ما يفرق بين الهواة والمحترفين. استخدم قوائم الفحص وبرومبتات التصحيح كدرع يحمي مشروعك من العشوائية.
                                </p>
                            </div>
                        </div>
                    </div>
